...
//http://120.46.190.255/小白白.php?url=https://v.qq.com/x/cover/mzc00200cbdrkxt/p4101s1nu5i.html
async function lazy(input, params) {
    log('input:', input);
    let headers = {'User-Agent': PC_UA};
    let timeout = 8000;
    let obj = await requestJson('http://120.46.190.255/小白白.php?url=' + input, {headers, timeout});
    return obj.url
}
