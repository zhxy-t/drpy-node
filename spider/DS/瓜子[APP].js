...
var rule = {
    ...
    lazy: async function() {
        ...
        let html = await this.gethtml('https://api.w32z7vtd.com/App/Resource/VurlDetail/showOne', body, this.headers);
    ...
    一级: async function() {
        ...
        // 发送请求并获取解密后的 HTML 数据
        const html = await this.gethtml("https://api.w32z7vtd.com/App/IndexList/indexList", body, this.headers);
    ...
    二级: async function() {
        ...
        // 发送请求并获取解密后的 HTML 数据
        const html = await this.gethtml("https://api.w32z7vtd.com/App/IndexPlay/playInfo", body, this.headers);
        ...
        // 发送请求并获取解密后的 HTML 数据
        const html3 = await this.gethtml("https://api.w32z7vtd.com/App/Resource/Vurl/show", body2, this.headers);
