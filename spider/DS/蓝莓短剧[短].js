...
globalThis.h_ost = 'https://new.tianjinzhitongdaohe.com';
...
var rule = {
    ...
    class_parse: async function () {
        const url = `${h_ost}/api/v1/app/screen/screenType`;
        try {
    ...
    一级: async function () {
        ...
        try {
            const url = `${h_ost}/api/v1/app/screen/screenMovie`;
            const response = await request(url, {
                method: 'POST',
                headers: rule.headers,
                body: payload
    ...
    try {
        ...
        const detailUrl = `${h_ost}/api/v1/app/play/movieDetails`;
    ...
    搜索: async function () {
        ...
        try {
            const url = `${h_ost}/api/v1/app/search/searchMovie`;
            const response = await request(url, {
                method: 'POST',
                headers: rule.headers,
                body: payload
    ...
    lazy: async function () {
        ...
        try {
            const url = `${h_ost}/api/v1/app/play/movieDetails`;
            const response = await request(url, {
                method: 'POST',
                headers: rule.headers,
                body: payload
